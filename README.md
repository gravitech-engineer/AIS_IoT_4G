...
![AIS - 4G Dev Kit - Internal Wiring Connections](AIS%20-%204G%20Dev%20Kit%20-%20Internal%20Wiring%20Connections.png)
 ...
 * `AzureIoTHub iot;` เริ่มต้นใช้งานไลบารี่ Azure IoT Hub สร้างออปเจค iot
 ...
 * `RS485`
   * [RS485_Slave_Echo](https://github.com/gravitech-engineer/AIS_IoT_4G/tree/main/examples/RS485//.ino) - ตัวอย่างการรับข้อมูลจาก RS485 Master แล้วตอบข้อมูลได้ที่รับมากลับไป
   ...
   * [XY_MD02_Read](https://github.com/gravitech-engineer/AIS_IoT_4G/tree/main/examples/RS485/XY_MD02_Read/XY_MD02_Read.ino) - ตัวอย่างการอ่านค่าอุณหภูมิและความชื้นจากเซ็นเซอร์รุ่น XY-MD02 ด้วย RS485 ผ่านโปรโตคอล MODBUS RTU
 * `Azure IoT`
