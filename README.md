 ...
 * [คำสั่งที่มีให้ใช้งาน](คำสั่งที่มีให้ใช้งาน)
   ...
   * [MAGELLAN_SIM7600E_MQTT.h](#include-magellan_sim7600e_mqtt.h)
 ...
 * `Magellan Platform`
   ...
   * `saveClientConfig`
     * [saveClientConfig](examples/Azure_IoT/4G/IoT_Hub_sample/IoT_Hub_sample.ino) - ตัวอย่างการส่งข้อมูลจากเซนเซอร์พร้อม Timestamp บนอุปกรณไปบน Magellan Platform ผ่าน 4G (SIM7600)
   * `getServerTime`
